...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="img\harshvardhan.jpg" alt="HARSHVARDHAN" width="400" height="300">
        <p><h2><strong>HARSHVARDHAN GANDHARV</strong></h2></p>
        <p><h5>Sangam University, BTECH-CSE VII SEM</h5></p>
      </div>
    </div>
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>Randeep Singh, Vice President, Comment Box</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>Sheetal Meena, Salesman, Rep Inc</span></h4>
      </div>
      <div class="item">
        <h4>"Could I... BE any more happy with this startup"<br><span>Sanjay, Actor, FriendsAlot</span></h4>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 9284439427 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> hvardhan.1602@gmail.com</p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(25.3211689, 74.4968095);
